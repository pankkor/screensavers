...
void start(void) {
  ...
  while (1) {
    ...
    plot0.points[plot0.end * 2 + 1] = clampf32(dt * 100.0f, 0.0f, 1.0f);//0.5f * sinf32(t_curve0) + 0.5f;
    ...
    // A 1
    // ^
    // if (plot0.end == PLOT_POINTS_COUNT - 1)
    glDrawArrays(GL_LINE_STRIP, 0, PLOT_POINTS_COUNT);
